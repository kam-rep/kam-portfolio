export const HERO_CONTENT = "Building scalable systems from code to cloud. DevOps & Cloud Engineer. Passionate about automating deployments, and optimizing cloud infrastructure with modern technologies.";
